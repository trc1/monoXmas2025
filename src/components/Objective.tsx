...
const Objective = observer(() => {
    ...
    return (
        <Modal
            isOpen={isVisible}
            onClose={handleClose}
            className={isVisible ? "modal-content-visible" : ""}
        >
            ...
            <p className="help-copy color-dark">
                ...
                <br />
                The room must feel like Christmas after all.
            </p>
            <p className="help-copy color-dark">
                First, hush the glow of{" "}
                <span className="underline-a">lamps</span> nearby,
                <br />
                Let softer shadows fill the sky.
            </p>
            <p className="help-copy color-dark">
                Set the <span className="underline-b">gramophone</span> spinning
                slow,
                <br />A tune that only winter knows.
            </p>
            <p className="help-copy color-dark">
                Wake <span className="underline-a">the fire</span>, let flames
                ignite,
                <br />
                Warmth and cheer throughout the night.
            </p>
            <p className="help-copy color-dark">
                Dress <span className="underline-b">the tree</span> in twinkling
                light
                <br />
                Then pause… and wait just out of sight.
            </p>
            <p className="help-copy color-dark">
